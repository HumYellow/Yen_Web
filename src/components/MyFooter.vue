<style type="text/css">
#footer{background:#fff;z-index:1;padding:40px 0; width:100%;text-align:center;box-shadow:2px -2px 20px #e9e9e9;}
#footer .footerCenter{width:1200px;margin:0 auto;}
...
#footer .footerTextBox{text-align:center;color:#999; font-size:12px;margin-top:20px;line-height:40px;}
